...
show_port_allocation() {
    ...
    echo "DNS Module (modules/05-dns-server):"
    ...
    echo "HTTP Module (modules/06-http-servers):"
    ...
    echo "Analysis Module (modules/04-network-analysis):"
...
suggest_solutions() {
    ...
    echo "   cd modules/05-dns-server && docker-compose up -d"
    echo "   cd modules/06-http-servers && docker-compose up -d"
    echo ""
    echo "2. Stop conflicting services:"
    echo "   docker-compose down"
    echo "   docker-compose -f modules/05-dns-server/docker-compose.yml down"
    echo "   docker-compose -f modules/06-http-servers/docker-compose.yml down"
    echo ""
